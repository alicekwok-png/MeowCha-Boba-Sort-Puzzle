...
export const MAX_CUPS = 26;           // 盤面最多 24 隻（22 真樽 + 2 廣告樽），再加「+樽」加一隻；走步編碼 from/to 各 1 byte
...
export class LocalServer {
  ...
  /**
   * 呢個盤面仲解唔解到？（工具 / 測試用。用戶 2026-09-06：UI **唔會**自動叫佢彈窗 ——
   * 玩家應該自己識開廣告樽 / 開委託槽救返，真係一步都行唔到先彈 showStuck。）
